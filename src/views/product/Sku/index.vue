  ...
  <div>
    <el-table :data="records" style="width: 100%" border>
      ...
      <el-table-column prop="prop" label="操作" width="width">
        <template slot-scope="{row,$index}">
          <el-button type="success" icon="el-icon-sort-down" size="mini" v-if="row.isSale==0" @click="cancel(row)"></el-button>
          ...
          <el-drawer :visible.sync="show" :show-close="false" size="50%">
            ...
            <el-row>
              ...
              <el-col :span="16">
                <el-tag type="success" v-for="(attr,index) in skuInfo.skuAttrValueList" :key="attr.id" style="margin:10px">{{attr.attrId}}--{{attr.valueId}}</el-tag>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="5">
